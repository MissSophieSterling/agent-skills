...
description: Plan and review on the strong model while cheaper models do narrow jobs in subagents, under a spawn cap. Use for large or parallel work (bulk edits, many searches, triaging batches of emails or tickets, drafting to a template), or when the user says "use subagents", "delegate" or "use a cheaper model".
license: MIT
metadata:
