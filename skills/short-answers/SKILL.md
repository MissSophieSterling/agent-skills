---
name: short-answers
description: Keep replies as short as the job allows without dropping what the user needs to act on. Use when the user says answers are too long, asks for concise, terse, caveman-style or ADHD-friendly replies, mentions output tokens or verbosity, or wants lean reply defaults in AGENTS.md or CLAUDE.md.
license: MIT
metadata:
